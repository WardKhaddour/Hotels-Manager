class CountriesCodes {
  ...
  static List<String> getCountries() {
    ...
    for (var items in countriesCodes) {
      countries.add(items['name'].toString());

      print((items['name']));
    }
    print(countries);
    for (var i = 0; i < countries.length; ++i) {
      print(countriesCodes[i]['name']);
      print(countriesCodes[i]['code']);
    }
    return countries;
  }

  static Map<String, String> getCountriesCodes() {
    var countries = <String, String>{};
    for (var items in countriesCodes) {
      countries[items['name']!] = items['code']!;
    }
    print(countries);
